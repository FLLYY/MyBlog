...
public class FileUtil {
	...
	public static void exportCategoriesToCsv(HttpServletResponse response, List<Category> categories)
	{
		...
		{
			writer.println("cgid,cgName,CgSlug,Count");
			for (Category category : categories)
			{
				writer.println(category.getCgid() + "," + category.getCgName() + "," + category.getCgSlug() + "," + category.getCount());
			}
		} catch (IOException e)
		{
			// 处理异常
